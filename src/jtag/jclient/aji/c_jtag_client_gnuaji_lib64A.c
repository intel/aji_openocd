...
#define FNAME_AJI_GET_HARDWARE__MINGW64 "_Z16aji_get_hardwarePjP12AJI_HARDWAREj"
AJI_ERROR c_aji_get_hardware(DWORD * hardware_count, AJI_HARDWARE * hardware_list, DWORD timeout) {
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_GET_HARDWARE__MINGW64); //extra (void*) cast to prevent warning re casting from AJI_ERROR aji_get_hardware(*)
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_GET_HARDWARE2__MINGW64 "_Z17aji_get_hardware2PjP12AJI_HARDWAREPPcj"
AJI_ERROR c_aji_get_hardware2(DWORD * hardware_count, AJI_HARDWARE * hardware_list, char **server_version_info_list, DWORD timeout) {
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib,FNAME_AJI_GET_HARDWARE2__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_FIND_HARDWARE__MINGW64 "_Z17aji_find_hardwarejP12AJI_HARDWAREj"
AJI_ERROR c_aji_find_hardware(DWORD persistent_id, AJI_HARDWARE * hardware, DWORD timeout) {
    assert(c_safestring_lib != NULL);
    assert(c_jtag_client_lib != NULL);
    typedef AJI_ERROR (*ProdFn)(DWORD, AJI_HARDWARE*, DWORD);
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_FIND_HARDWARE__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_FIND_HARDWARE_A__MINGW64 "_Z17aji_find_hardwarePKcP12AJI_HARDWAREj"
AJI_ERROR c_aji_find_hardware_a(const char * hw_name, AJI_HARDWARE * hardware, DWORD timeout) {
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_FIND_HARDWARE_A__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_READ_DEVICE_CHAIN__MINGW64 "_Z21aji_read_device_chainP9AJI_CHAINPjP10AJI_DEVICEb"
AJI_ERROR c_aji_read_device_chain(AJI_CHAIN_ID chain_id, DWORD * device_count, AJI_DEVICE * device_list, _Bool auto_scan) {
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_READ_DEVICE_CHAIN__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_GET_NODES__MINGW64 "_Z13aji_get_nodesP9AJI_CHAINjPjS1_"
AJI_ERROR AJI_API c_aji_get_nodes(
    ...
    ProdFn pfn = (ProdFn)(void*)dlsym(c_jtag_client_lib, FNAME_AJI_GET_NODES__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_GET_NODES_A__MINGW64 "_Z13aji_get_nodesP9AJI_CHAINjPjS1_S1_"
AJI_ERROR AJI_API c_aji_get_nodes_a(
    ...
    ProdFn pfn = (ProdFn)(void*)dlsym(c_jtag_client_lib, FNAME_AJI_GET_NODES_A__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_GET_NODES_B__MINGW64 "_Z13aji_get_nodesP9AJI_CHAINjP11AJI_HIER_IDPjP12AJI_HUB_INFO"
AJI_ERROR AJI_API c_aji_get_nodes_b(
    ...
    ProdFn pfn = (ProdFn)(void*)dlsym(c_jtag_client_lib, FNAME_AJI_GET_NODES_B__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_LOCK__MINGW64 "_Z8aji_lockP8AJI_OPENj14AJI_PACK_STYLE"
AJI_ERROR c_aji_lock(AJI_OPEN_ID open_id, DWORD timeout, AJI_PACK_STYLE pack_style) {
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_LOCK__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
AJI_ERROR c_aji_unlock_lock_chain(AJI_OPEN_ID unlock_id, AJI_CHAIN_ID lock_id) {
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_UNLOCK_LOCK_CHAIN__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
AJI_ERROR c_aji_unlock(AJI_OPEN_ID open_id) {   
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_UNLOCK__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
    return (pfn)(open_id);
...
#define FNAME_AJI_LOCK_CHAIN__MINGW64 "_Z14aji_lock_chainP9AJI_CHAINj"
AJI_ERROR c_aji_lock_chain(AJI_CHAIN_ID chain_id, DWORD timeout) {
    assert(c_safestring_lib != NULL);
    assert(c_jtag_client_lib != NULL);
    typedef AJI_ERROR (*ProdFn)(AJI_CHAIN_ID, DWORD);
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_LOCK_CHAIN__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
AJI_ERROR c_aji_unlock_chain(AJI_CHAIN_ID chain_id) {
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_UNLOCK_CHAIN__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
    return (pfn)(chain_id);
...
AJI_ERROR c_aji_unlock_chain_lock(AJI_CHAIN_ID unlock_id, AJI_OPEN_ID lock_id, AJI_PACK_STYLE pack_style) {
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_UNLOCK_CHAIN_LOCK__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
AJI_API AJI_ERROR c_aji_flush(AJI_OPEN_ID open_id) {
    ...
    assert(c_jtag_client_lib != NULL);
    typedef AJI_ERROR(*ProdFn)(AJI_OPEN_ID);
    ProdFn pfn = (ProdFn)(void*)dlsym(c_jtag_client_lib, FNAME_AJI_FLUSH__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
    return (pfn)(open_id);
...
#define FNAME_AJI_OPEN_DEVICE__MINGW64 "_Z15aji_open_deviceP9AJI_CHAINjPP8AJI_OPENPK9AJI_CLAIMjPKc"
AJI_ERROR c_aji_open_device(AJI_CHAIN_ID chain_id, DWORD tap_position, AJI_OPEN_ID * open_id, const AJI_CLAIM * claims, DWORD claim_n, const char * application_name){
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_OPEN_DEVICE__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_OPEN_DEVICE_A__MINGW64 "_Z15aji_open_deviceP9AJI_CHAINjPP8AJI_OPENPK10AJI_CLAIM2jPKc"
...
AJI_ERROR c_aji_close_device(AJI_OPEN_ID open_id) {
    ...
    assert(c_jtag_client_lib != NULL);
    typedef AJI_ERROR (*ProdFn)(AJI_OPEN_ID);
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_CLOSE_DEVICE__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
    return (pfn)(open_id);
...
AJI_ERROR c_aji_open_entire_device_chain(AJI_CHAIN_ID chain_id, AJI_OPEN_ID * open_id, AJI_CHAIN_TYPE style, const char * application_name) {
    ...
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_OPEN_ENTIRE_DEVICE_CHAIN__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_OPEN_NODE__MINGW64 "_Z13aji_open_nodeP9AJI_CHAINjjPP8AJI_OPENPK9AJI_CLAIMjPKc"
AJI_ERROR c_aji_open_node(    AJI_CHAIN_ID chain_id,
    ...
    ProdFn pfn = (ProdFn)(void*)dlsym(c_jtag_client_lib, FNAME_AJI_OPEN_NODE__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_OPEN_NODE_A__MINGW64 "_Z13aji_open_nodeP9AJI_CHAINjjjPP8AJI_OPENPK9AJI_CLAIMjPKc"
AJI_ERROR c_aji_open_node_a(  AJI_CHAIN_ID chain_id,
    ...
    ProdFn pfn = (ProdFn)(void*)dlsym(c_jtag_client_lib, FNAME_AJI_OPEN_NODE_A__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_OPEN_NODE_B__MINGW64 "_Z13aji_open_nodeP9AJI_CHAINjPK11AJI_HIER_IDPP8AJI_OPENPK10AJI_CLAIM2jPKc"
AJI_ERROR c_aji_open_node_b(  AJI_CHAIN_ID chain_id,
    ...
    ProdFn pfn = (ProdFn)(void*)dlsym(c_jtag_client_lib, FNAME_AJI_OPEN_NODE_B__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
AJI_ERROR c_aji_test_logic_reset(AJI_OPEN_ID open_id) {
    ...
    assert(c_jtag_client_lib != NULL);
    typedef AJI_ERROR (*ProdFn)(AJI_OPEN_ID*);
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_TEST_LOGIC_RESET__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
    return (pfn)(open_id);
...
#define FNAME_AJI_DELAY__MINGW64 "_Z9aji_delayP8AJI_OPENj"
AJI_ERROR c_aji_delay(AJI_OPEN_ID open_id, DWORD timeout_microseconds) {
    assert(c_safestring_lib != NULL);
    assert(c_jtag_client_lib != NULL);
    typedef AJI_ERROR (*ProdFn)(AJI_OPEN_ID, DWORD);
    ProdFn pfn = (ProdFn) (void*) dlsym(c_jtag_client_lib, FNAME_AJI_DELAY__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_RUN_TEST_IDLE__MINGW64 "_Z17aji_run_test_idleP8AJI_OPENj"
AJI_ERROR c_aji_run_test_idle(AJI_OPEN_ID open_id, DWORD num_clocks) {
    assert(c_safestring_lib != NULL);
    assert(c_jtag_client_lib != NULL);
    typedef AJI_ERROR(*ProdFn)(AJI_OPEN_ID, DWORD);
    ProdFn pfn = (ProdFn) (void*)dlsym(c_jtag_client_lib, FNAME_AJI_RUN_TEST_IDLE__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_RUN_TEST_IDLE_A__MINGW64 "_Z17aji_run_test_idleP8AJI_OPENjj"
AJI_ERROR c_aji_run_test_idle_a(AJI_OPEN_ID open_id, DWORD num_clocks, DWORD flags) {
    ...
    ProdFn pfn = (ProdFn) (void*)dlsym(c_jtag_client_lib, FNAME_AJI_RUN_TEST_IDLE_A__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_ACCESS_IR__MINGW64 "_Z13aji_access_irP8AJI_OPENjPjj"
AJI_ERROR c_aji_access_ir(AJI_OPEN_ID open_id, DWORD instruction, DWORD * captured_ir, DWORD flags) {
    ...
    ProdFn pfn = (ProdFn) (void*)dlsym(c_jtag_client_lib, FNAME_AJI_ACCESS_IR__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_ACCESS_IR_A__MINGW64 "_Z13aji_access_irP8AJI_OPENjPKhPhj"
AJI_ERROR c_aji_access_ir_a(AJI_OPEN_ID open_id, DWORD length_ir, const BYTE * write_bits, BYTE * read_bits, DWORD flags) {
    ...
    ProdFn pfn = (ProdFn) (void*)dlsym(c_jtag_client_lib, FNAME_AJI_ACCESS_IR_A__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_ACCESS_IR_MULTIPLE__MINGW64 "_Z22aji_access_ir_multiplejPKP8AJI_OPENPKjPj"
AJI_ERROR c_aji_access_ir_multiple(DWORD num_devices, const AJI_OPEN_ID * open_id, const DWORD * instructions, DWORD * captured_irs) {
    ...
    ProdFn pfn = (ProdFn) (void*)dlsym(c_jtag_client_lib, FNAME_AJI_ACCESS_IR_MULTIPLE__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_ACCESS_DR__MINGW64 "_Z13aji_access_drP8AJI_OPENjjjjPKhjjPh"
AJI_ERROR c_aji_access_dr(AJI_OPEN_ID open_id, DWORD length_dr, DWORD flags, DWORD write_offset, DWORD write_length, const BYTE * write_bits, DWORD read_offset, DWORD read_length, BYTE * read_bits) {
    ...
    ProdFn pfn = (ProdFn) (void*)dlsym(c_jtag_client_lib, FNAME_AJI_ACCESS_DR__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
...
#define FNAME_AJI_ACCESS_DR_A__MINGW64 "_Z13aji_access_drP8AJI_OPENjjjjPKhjjPhj"
...
#define FNAME_AJI_ACCESS_OVERLAY__MINGW64 "_Z18aji_access_overlayP8AJI_OPENjPj"
AJI_API AJI_ERROR c_aji_access_overlay(AJI_OPEN_ID node_id, DWORD overlay, DWORD* captured_overlay){
    assert(c_safestring_lib != NULL);
    assert(c_jtag_client_lib != NULL);
    typedef AJI_ERROR(*ProdFn)(AJI_OPEN_ID, DWORD, DWORD*);
    ProdFn pfn = (ProdFn)(void*)dlsym(c_jtag_client_lib, FNAME_AJI_ACCESS_OVERLAY__MINGW64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
