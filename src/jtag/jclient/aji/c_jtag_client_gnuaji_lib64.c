...
#define FNAME_AJI_ACCESS_IR_MULTIPLE__LINUX64 "_Z22aji_access_ir_multiplejPKP8AJI_OPENPKjPj"
AJI_ERROR c_aji_access_ir_multiple(DWORD num_devices, const AJI_OPEN_ID * open_id, const DWORD * instructions, DWORD * captured_irs) {
    ...
    ProdFn pfn = (ProdFn) (void*)dlsym(c_jtag_client_lib, FNAME_AJI_ACCESS_IR_MULTIPLE__LINUX64);
    if (pfn == NULL) {
        return AJI_FAILURE;
    }
